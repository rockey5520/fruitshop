...
// Server lists the fruit service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Get    http.Handler
	Show   http.Handler
...
// New instantiates HTTP handlers for all the fruit service endpoints using the
...
func (s *Server) Service() string { return "fruit" }
...
// Mount configures the mux to serve the fruit endpoints.
func Mount(mux goahttp.Muxer, h *Server) {
	MountGetHandler(mux, h.Get)
	MountShowHandler(mux, h.Show)
}

// MountGetHandler configures the mux to serve the "fruit" service "get"
// endpoint.
...
// the "fruit" service "get" endpoint.
func NewGetHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "fruit")
...
// MountShowHandler configures the mux to serve the "fruit" service "show"
// endpoint.
...
// the "fruit" service "show" endpoint.
func NewShowHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
