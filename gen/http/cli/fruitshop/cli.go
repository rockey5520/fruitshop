...
func ParseEndpoint(
	...
	var (
		...
		userAddUserIDFlag = userAddFlags.String("user-id", "REQUIRED", "User Id of the customer")

		userGetFlags      = flag.NewFlagSet("get", flag.ExitOnError)
		userGetUserIDFlag = userGetFlags.String("user-id", "REQUIRED", "User Id of the customer")
		...
		couponAddUserIDFlag = couponAddFlags.String("user-id", "REQUIRED", "User Id of the customer")
		...
		fruitGetNameFlag = fruitGetFlags.String("name", "REQUIRED", "Name of the fruit")
		...
		cartAddUserIDFlag = cartAddFlags.String("user-id", "REQUIRED", "User Id of the customer")

		cartRemoveFlags      = flag.NewFlagSet("remove", flag.ExitOnError)
		cartRemoveBodyFlag   = cartRemoveFlags.String("body", "REQUIRED", "")
		cartRemoveUserIDFlag = cartRemoveFlags.String("user-id", "REQUIRED", "User Id of the customer")
...
func userUsage() {
	fmt.Fprintf(os.Stderr, `User service allows access to customers
Usage:
...
Add implements add.
    -body JSON: 
    -user-id STRING: User Id of the customer
...
func couponUsage() {
	fmt.Fprintf(os.Stderr, `The coupon service allows coupon management
Usage:
...
func fruitUsage() {
	fmt.Fprintf(os.Stderr, `This service allows access to get details about fruits
Usage:
