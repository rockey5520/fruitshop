...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"./frontend/dist/fruitshop-ui/", "GET", "/"},
...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountFrontendDistFruitshopUI(mux, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		upath := path.Clean(r.URL.Path)
		rpath := upath
		http.ServeFile(w, r, path.Join("./frontend/dist/fruitshop-ui/", rpath))
	}))
...
// MountFrontendDistFruitshopUI configures the mux to serve GET request made to
// "/".
func MountFrontendDistFruitshopUI(mux goahttp.Muxer, h http.Handler) {
